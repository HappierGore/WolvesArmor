 ...
 * @author HappieGore
 */
public class AgressiveMode extends Behaviour {

    public AgressiveMode(GUI inventory) {
        super(inventory);
        this.loadMainItem();
    }
    ...
    public void onClick(InventoryClickEvent e) {
        ...
        wolfData.setBehaviour(Behaviours.PASSIVE);
        RefreshTargets.findWolf(wolfData.getUUID()).setTarget(null);
    ...
    public ItemStack generateMainItem() {
        String itemPath = "OtherItems.AgressiveMode";
